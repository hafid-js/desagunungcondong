                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                <label class="font-weight-bold" for="nomor_kk">Nomor KK <code id="tampil_nomor_kk"
                                        style="display: none;">
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <input type="checkbox" title="Centang jika belum memiliki Nomor KK"
                                                id="nomor_kk_sementara">
                                        </div>
                                    </div>
                                    <input id="nomor_kk" name="nomor_kk" class="form-control input-sm required nomor_kk"
            ...
            <div class="col-12 col-md-12 col-lg-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-lg-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="tgl_lapor" class="form-control datepicker">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section-title mt-0">DATA KELAHIRAN :</div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
...
@push('scripts')
    ...
    $('#tgl_masuk').datetimepicker({
        ...
        $(document).ready(function() {
            ...
            $('#nomor_kk_sementara').change(function() {
                var cek_nomor_kk = '';
                var nomor_kk_sementara_berikut = '0520304200900006';
                var nomor_kk_asli = '';
                if ($('#nomor_kk_sementara').prop('checked')) {
                    $('#nomor_kk').removeClass('nomor_kk');
                    if (cek_nomor_kk != '0') $('#nomor_kk').val(nomor_kk_sementara_berikut);
                    $('#nomor_kk').prop('readonly', true);
                    $('#tampil_nomor_kk').show();
                } else {
                    $('#nomor_kk').addClass('nomor_kk');
                    $('#nomor_kk').val(nomor_kk_asli);
                    $('#nomor_kk').prop('readonly', false);
                    $('#tampil_nomor_kk').hide();
                }
            });

            $('#nomor_kk_sementara').change();
        });
    </script>
@endpush
