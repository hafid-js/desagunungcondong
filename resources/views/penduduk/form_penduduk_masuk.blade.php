            ...
            <div class="col-12 col-md-12 col-lg-9">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-arrow-left"></i><a href="">&nbsp;Kembali Ke Daftar Penduduk</a>
                    </div>
                    <div class="card-body">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold" for="inputNIK">NIK</label>
                                <input type="text" class="form-control" id="inputNIK" placeholder="Nomor NIK">
                            </div>
                        ...
                        <textarea class="form-control col-md-4 h-50" placeholder="Maksud dan Tujuan Kedatangan"></textarea>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select name="" id="" class="form-control">
                                    ...
                                    <option value="">DUA KEWARGANEGARAAN</option>
                                </select>
                            </div>
                            <div class="form-group col-md-8">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                <label for="" class="font-weight-bold">Nomor KITAS/KTP</label>
                                <input type="text" class="form-control" placeholder="Nomor KITAS/KTP">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label for=""
                                    class="font-weight-bold">No.&nbsp;Akta&nbsp;Nikah&nbsp;(Buku&nbsp;Nikah)/Perkawinan</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="" class="font-weight-bold">Nomor BPJS Ketenagakerjaan</label>
