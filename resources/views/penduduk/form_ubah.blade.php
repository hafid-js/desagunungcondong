...
@section('breadcrumb')
    @parent
    <div class="breadcrumb-item">Biodata Penduduk</div>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="nik" name="nik" placeholder="3306132204980002"  class="form-control input-sm required nik"
                            ...
                            <div class="form-group col-md-8">
                                <label class="font-weight-bold" for="inputNama">Nama Lengkap <code>(Tanpa
                                        Gelar)</code></label>
                                <input type="text" class="form-control" value="AHMAD ALLIF RIZKI" id="inputNama" placeholder="Nama Lengkap">
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-md table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-dark font-weight-bold">WAJIB</td>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <select class="form-control" id="statusPenduduk" disabled>
                                    <option value="">Pilih Status Penduduk</option>
                                    <option value="" selected>TETAP</option>
                        ...
                        <div class="statusPenduduk" style="display: none">
                            <div class="section-title mt-0">DATA PENDUDUK TIDAK TETAP :</div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control" value="PURWOREJO" placeholder="Tempat Lahir">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4 col-sm-12 col-lg-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="tgl_lahir" class="form-control datepicker">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-sm-12 col-lg-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="tgl_perceraian" class="form-control datepicker">
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-lg-4">
                                <label class="font-weight-bold">Tanggal Perkawinan</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <li class="fas fa-calendar"></li>
                                    ...
                                    <input type="text" id="tgl_perkawinan" class="form-control datepicker">
                                </div>
                            </div>
                            <div class="form-group col-md-8">
